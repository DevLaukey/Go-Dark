              ...
              <a class="blog_card-link" href="#">
                <article class="blog_blog-card">
                  ...
                  <div class="blog_article-details">
                    <h4 class="blog_post-category">asdad</h4>
                    <h3 class="blog_post-title">sadc</h3>
                    <p class="blog_post-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam deserunt incidunt veritatis cupiditate, iusto sit voluptatum veniam laborum molestiae nihil sapiente error, fugit, minima cumque modi! Ea aliquam commodi provident.</p>
                    <p class="blog_post-author">By sadcs</p>
                  </div>
                </article>
              </a>
              <a class="blog_card-link" href="#">
                <article class="blog_blog-card">
                  ...
                  <div class="blog_article-details">
                    <h4 class="blog_post-category">asdad</h4>
                    <h3 class="blog_post-title">sadc</h3>
                    <p class="blog_post-description">lorem Ips</p>
                    <p class="blog_post-author">By sadcs</p>
                  </div>
                </article>
              </a>
