...
const Home = () => {
  ...
  const earth = document.getElementById("earth_background-text");

      const onMouseOver = e =>{
        earth.style.display ="block";
          console.log(e.target.parentNode.parentNode.children[0]); // run
    ...
    <Layout title="Home">
      ...
      >
        <Parallax ref={parallax} pages={3}>
          ...
          >
            <h3 id="earth_background-text" styles="display:none" className="earth_background-text">
              Portland Oregon
            </h3>
